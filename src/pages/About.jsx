      ...
      <section className="bg-navy-deep px-4 py-16 text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-cream px-6 py-3 font-semibold text-navy-deep transition hover:scale-105"
          >
            <svg viewBox="0 0 24 24" className="h-5 w-5 fill-navy-deep">
